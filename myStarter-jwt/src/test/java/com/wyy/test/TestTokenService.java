...
public class TestTokenService {
    ...
    private String jwt = "eyJhdXRob3IiOiLmnY7lhbTljY4iLCJtb2R1bGUiOiJKV1QtVEVTVCIsImFsZyI6IkhTMjU2In0.eyJtc2ciOiLkuJbnlYzkuIrniIblj6_niLHnmoTogIHluIgg4oCU4oCUIOeIhuWPr-eIseeahOWwj-.kk508jT6JaYtndT-uiIUUyQnsFmJ7KMkIeB4mFeL1vI"; // 测试解析使用的
    @Test
    public void testCreateToken() {
        ...
        map.put("name", "hrwyy");
        map.put("flag", "1");
        map.put("roles", Set.of("dept", "emp", "rating", "user")); // 用户角色信息
        map.put("actions", Set.of("dept:list", "emp:add", "user:add", "rating:list"));
